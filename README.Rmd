...
##### Dependencies
Installation of this R package requires R and r-devtools.  If you use prefer the use of conda you can create the base environment with `conda create --name r-RWRtoolkit -c conda-forge r-base r-devtools`.  You can also install devtools from within a base R environment with `install.packages("devtools")`.
...
*Note: this method is not yet available for general use as repository is private.*  You can install the released version of RWRtoolkit from [GitHub](https://github.com/dkainer/RWRtoolkit/) with:
