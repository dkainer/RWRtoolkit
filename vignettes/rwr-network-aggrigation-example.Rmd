...
It's not impossibe that you'll at some point with to collapse down your multiplex network into a multigraph.  RWRtoolkit provides two methods of multiplex network aggregation. 
...
png('merged_with_edge_count.png', width=1000, height=1000, res=300)
par(mar=c(1,1,1,1))
set.seed(42)
