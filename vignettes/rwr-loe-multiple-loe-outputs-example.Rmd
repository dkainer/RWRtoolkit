...
vignette: >
  %\VignetteIndexEntry{UsingAdvanced RWR-LOE To Explore Multiple LOE Outputs}
...
comprehensiveNetworkPath <- '../../RWRtoolkit-data/Comprehensive_Network_AT_d0.5_v02.RData'
```
