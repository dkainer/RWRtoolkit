...
output <- capture.output({
  V(layer1)$label.cex <- 0.65
  V(layer2)$label.cex <- 0.65
  V(layer3)$label.cex <- 0.65
  
  png('layers.png', width=700, height=350, res=300)
  par(mfrow= c(1,3), mar=c(1,1,1,1))
  igraph::plot.igraph(layer1, main="Layer 1", vertex.size=35)
  igraph::plot.igraph(layer2, main="Layer 2", vertex.size=35)
  igraph::plot.igraph(layer3, main="Layer 3", vertex.size=35)
  dev.off()
})
