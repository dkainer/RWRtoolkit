...
genePool <- as_tibble(nw.mpo$Pool_of_Nodes)
genePool <- genePool %>% dplyr::filter(!(V1 %in% GABAergicSeedGenes))
randomSample <- sample(genePool, replace = FALSE, size = newlySampleGeneCount)
