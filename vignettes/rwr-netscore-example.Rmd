...
plot(goldLayer, main="Gold Layer")
plot(permutedGoldLayer, main="Permuted Gold Layer")
par(mfrow=c(1,1))
```
...
edgeWidth <- lapply(E(layerNetwork)$weight, function (x) x * 0.5)

plot.igraph(layerNetwork, edge.width=edgeWidth, layout=igraph::layout_with_graphopt(layerNetwork), edge.curved=seq(-0.5, 0.5, length = ecount(layerNetwork)), main="Interlayer Netscores")
```
